/**
 * Sistema de Certificação PNSB - CertificateGenerator
...
class CertificateGenerator {
    ...
    addHeader() {
        ...
        this.pdf.setFont('helvetica', 'bold');
        this.pdf.text('PESQUISA NACIONAL DE SANEAMENTO BÁSICO (PNSB)', centerX, 58, { align: 'center'});
    ...
    addMainContent() {
        ...
        // Texto de conclusão
        const conclusionText = `concluiu com êxito o curso de capacitação, cumprindo a carga horária de 40 horas e obtendo a nota final de ${this.data.finalScore}%, estando apto(a) a participar da coleta de dados da PNSB.`;
    ...
    addWatermark() {
        ...
        this.pdf.text('PNSB', this.pageWidth / 2, this.pageHeight / 2 + 20, {
            angle: 45,
            align: 'center'
        });
    }
     ...
     */
    downloadPDF(filename = `certificado-pnsb-${this.data.username}.pdf`) {
