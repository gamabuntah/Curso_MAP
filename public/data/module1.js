...
Object.assign(window.modulos_data, {
  "1": {
    ...
    "cards": [
      ...
      {
        "type": "default",
        "title": "📋 Orientações Gerais para o Preenchimento do Questionário",
        "content": "<b>Orientações fundamentais que devem ser seguidas:</b><br><br>• <b>Os quesitos são agrupados em blocos de acordo com o assunto</b><br><br>• <b>Expressões e conceitos que exigem esclarecimento estão definidos no manual ou nos questionários</b><br><br>• <b>Abreviações só podem ser usadas se os campos forem insuficientes para o preenchimento por extenso</b><br><br>• <b>Existem comandos de sequência (setas ou instruções redigidas) que podem determinar saltos no preenchimento, deixando alguns quesitos em branco</b><br><br>• <b>Caso o respondente não saiba informar dados como ano de vistoria/levantamento ou quantidade de itens, o item será considerado inexistente</b><br><br>• <b>Nenhum quesito pode ser deixado em branco, exceto nos saltos previstos ou quando há orientação expressa no manual</b><br><br>• <b>O campo de observações deve ser usado para complementar informações, sempre indicando o nome do bloco e o número do quesito</b><br><br>• <b>O Bloco \"RESPONSÁVEL PELA INFORMAÇÃO DO PRESTADOR DE SERVIÇO\" deve ser preenchido obrigatoriamente no início do questionário</b>"
      },
      {
        "type": "dica",
        "title": "💡 Dica",
