...
Object.assign(window.modulos_data, {
  "1": {
    ...
    "audio": "https://github.com/gamabuntah/Curso_MAP/raw/main/public/MAP/Audios/Curso%20MAP%20-%20Mod%201.mp3",
    "cards": [
      {
        "type": "default",
        "title": "📋 Resumo",
        "content": "Este curso tem como objetivo capacitar agentes e técnicos do IBGE para atuar na coleta adequada do questionário da PNSB (Pesquisa Nacional de Saneamento Básico). O Módulo 1 foca na Drenagem e Manejo de Águas Pluviais (MAP), um componente essencial do saneamento básico brasileiro, detalhando a importância da PNSB como um levantamento fundamental para planejar e aprimorar a gestão municipal dos serviços de saneamento, coletando informações de prestadores em todos os 5.570 municípios brasileiros. O módulo aborda conceitos cruciais como a distinção entre microdrenagem e macrodrenagem, além da drenagem urbana e rural, destacando a necessidade de reduzir impactos de chuvas e cheias e a função das infraestruturas verdes. O objetivo é capacitar os profissionais para realizar uma coleta precisa e qualificada, fornecendo um cenário atualizado para análises das condições ambientais e sua implicação na saúde e qualidade de vida."
      },
      {
        "type": "default",
