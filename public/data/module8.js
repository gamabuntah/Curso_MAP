...
Object.assign(window.modulos_data, {
  "8": {
    ...
    "audio": "MAP/Audios/Curso MAP - Mod 8.wav",
    "cards": [
      {
        "type": "default",
        "title": "📋 Resumo",
        "content": "Este módulo final aborda o Bloco MAP (Manejo de Águas Pluviais), focando em aspectos cruciais de planejamento e gestão, como a existência de um Plano Diretor de Drenagem e Manejo de Águas Pluviais e a cobrança por esses serviços. O objetivo é capacitar o técnico a identificar se o município possui um planejamento formal para a drenagem, se há instrumentos de cobrança pelos serviços prestados e se são realizadas ações de educação ambiental voltadas para o tema. O bloco investiga a existência do plano, os instrumentos de planejamento utilizados, as formas de cobrança (taxas, tarifas) e as iniciativas educativas para conscientizar a população sobre a importância do manejo adequado das águas da chuva."
      },
      {
        "type": "default",
        "title": "8.1 Bloco MAP - Manejo de Águas Pluviais",
        "content": "O objetivo deste bloco é capacitar o técnico para identificar a existência do Plano Diretor de Drenagem e Manejo de Águas Pluviais, cobrança e educação ambiental."
      },
      {
        "type": "default",
        "title": "8.1.1 Plano Diretor de Drenagem (Quesito 1)",
        "content": "Este quesito investiga se, em 2024, o município dispunha de um Plano Diretor de Drenagem e Manejo de Águas Pluviais Urbanas. Este plano é a ferramenta para planejar as ações de drenagem, considerando o crescimento da cidade e as questões ambientais. A resposta \"Não\" para este quesito leva ao quesito 3."
      },
      {
        "type": "default",
        "title": "8.1.2 Abrangência do Plano (Quesito 2)",
        "content": "Se a resposta anterior for \"Sim\", este quesito pergunta qual a abrangência do Plano Diretor.<br><ul><li><b>Total:</b> Abrange toda a área urbana do município.</li><li><b>Parcial:</b> Abrange apenas uma parte da área urbana.</li></ul>"
      },
      {
        "type": "dica",
        "title": "💡 Dica",
        "content": "O Plano Diretor de Drenagem é um documento técnico fundamental. Se o informante não tiver certeza, peça para que ele verifique junto ao setor de planejamento ou obras da prefeitura."
      },
      {
        "type": "default",
        "title": "8.1.3 Outros Instrumentos de Planejamento (Quesito 3)",
        "content": "Este quesito investiga se, em 2024, o município utilizava outros instrumentos para o planejamento das ações de drenagem e manejo de águas pluviais, mesmo que não tenha um Plano Diretor específico. É possível marcar mais de uma opção.<br><ul><li>Zoneamento de áreas inundáveis</li><li>Mapeamento de áreas de risco</li><li>Código de obras</li><li>Lei de uso e ocupação do solo</li><li>Outro(s)</li><li>Não utiliza</li></ul>"
      },
      {
        "type": "exemplo",
        "title": "📝 Exemplo",
        "content": "Um município pode não ter um Plano Diretor de Drenagem, mas pode ter um Código de Obras que exige a construção de sistemas de captação de água da chuva em novos loteamentos. Isso deve ser marcado."
      },
      {
        "type": "default",
        "title": "8.1.4 Cobrança pelo Serviço (Quesito 4)",
        "content": "Este quesito pergunta se, em 2024, houve cobrança pelos serviços de drenagem e manejo de águas pluviais no município. A resposta \"Não\" para este quesito leva ao quesito 6."
      },
      {
        "type": "default",
        "title": "8.1.5 Forma de Cobrança (Quesito 5)",
        "content": "Se a resposta anterior for \"Sim\", este quesito detalha a forma como a cobrança foi realizada.<br><ul><li><b>Taxa ou tarifa específica:</b> Um valor cobrado especificamente pelo serviço de drenagem.</li><li><b>Inclusa no carnê do IPTU:</b> A cobrança vem junto com o imposto predial.</li><li><b>Inclusa na conta de água/esgoto:</b> A cobrança vem junto com a conta de outros serviços de saneamento.</li><li><b>Outra forma:</b> Outra maneira de cobrar pelo serviço.</li></ul>"
      },
      {
        "type": "atencao",
        "title": "⚠️ Atenção",
        "content": "Muitas vezes, a cobrança não é explícita, mas está embutida em outros impostos ou taxas. É importante investigar com o informante."
      },
      {
        "type": "default",
        "title": "8.1.6 Educação Ambiental (Quesito 6)",
      ...
      },
      {
        "type": "resumo",
        "title": "📊 Resumo Visual",
        "content": "<table><tr><th>Instrumento</th><th>Função</th></tr><tr><td>Plano Diretor de Drenagem</td><td>Planejamento mestre de longo prazo para águas pluviais</td></tr><tr><td>Zoneamento</td><td>Delimitar áreas com restrições de uso (ex: áreas de risco)</td></tr><tr><td>Código de Obras</td><td>Definir regras para novas construções</td></tr><tr><td>Lei de Uso e Ocupação do Solo</td><td>Organizar o crescimento da cidade</td></tr></table>"
      }
    ],
    "quiz": {
