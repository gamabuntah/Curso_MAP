...
Object.assign(window.modulos_data, {
  "2": {
    ...
    "audio": "https://github.com/gamabuntah/Curso_MAP/raw/main/public/MAP/Audios/Curso%20MAP%20-%20Mod%202.mp3",
    "cards": [
      {
        "type": "default",
        "title": "📋 Resumo",
      ...
      "questions": [
        {
          ...
          "answer": "Identificar o responsável pela infraestrutura e serviços de drenagem e manejo de águas pluviais",
          "feedback": "O Bloco CZP (Caracterização do Prestador) visa identificar o responsável pelo cadastro, planejamento, projeto, instalação, ampliação, adequação, monitoramento, manutenção e operação da infraestrutura de drenagem em diversas áreas e dispositivos. Também identifica o responsável por manter o mapeamento atualizado das áreas de risco e fornecer informações ao sistema de alerta da Defesa Civil."
        },
        {
          ...
          "answer": "O questionário deve ser encerrado",
          "feedback": "Se a resposta ao quesito sobre serviços executados for \"Não\", o questionário deve ser encerrado. Isso é fundamental para garantir que apenas entidades que realmente prestam serviços de drenagem e manejo de águas pluviais sejam incluídas na pesquisa, mantendo a relevância e qualidade dos dados coletados pela PNSB."
        },
        {
          ...
          "answer": "Manutenção em sarjetas, bocas de lobo e galerias",
          "feedback": "A manutenção em sarjetas, bocas de lobo e galerias é um exemplo típico de serviço de drenagem e manejo de águas pluviais. Outros exemplos incluem controle de inundações, limpeza de rios, córregos e igarapés, operação de grandes dispositivos de drenagem, e planejamento, obras, instalação, ampliação, fiscalização e supervisão de sistemas de drenagem."
        },
        {
          ...
          "answer": "Registro da quantidade de chuva que cai em uma determinada área e num determinado tempo",
          "feedback": "O monitoramento pluviométrico é o registro da quantidade de chuva que cai em uma determinada área e num determinado tempo. Este tipo de monitoramento é fundamental para o planejamento de sistemas de drenagem, pois permite entender os padrões de precipitação e dimensionar adequadamente as infraestruturas de drenagem."
        },
        {
          ...
          "answer": "Transbordamento de um curso d'água",
          "feedback": "Uma inundação é caracterizada pelo transbordamento de um curso d'água. É importante distinguir inundação de outros fenômenos: alagamento é o acúmulo de águas por deficiência na drenagem; enxurrada é grande quantidade de água que corre com violência; e deslizamento são deslocamentos de solo pela encosta."
        },
        {
          ...
          "answer": "Alagamentos são acúmulo de águas por deficiência na drenagem; enxurradas são grande quantidade de água que corre com violência",
          "feedback": "A diferença é fundamental: alagamentos são o acúmulo de águas por deficiência na drenagem urbana, geralmente em áreas baixas ou com sistemas de drenagem inadequados. Enxurradas são grandes quantidades de água que correm com violência, geralmente em áreas de declive acentuado, causando erosão e arrastando sedimentos."
        },
        {
          ...
          "answer": "Limpeza de bocas de lobo, desobstrução de galerias, desassoreamento de córregos",
          "feedback": "A manutenção no contexto do MAP inclui a recuperação de infraestrutura, limpeza e reparos. Especificamente, inclui limpeza de bocas de lobo, desobstrução de galerias, desassoreamento de córregos, reparos em dispositivos de drenagem e outras ações necessárias para manter o funcionamento adequado do sistema de drenagem."
        },
        {
          ...
          "answer": "Parte da administração indireta, criada por lei específica, com personalidade jurídica de direito público",
          "feedback": "Uma autarquia é parte da administração indireta, criada por lei específica, com personalidade jurídica de direito público. É diferente da administração direta (órgãos ligados diretamente ao Poder Executivo) e das empresas públicas (que têm personalidade jurídica de direito privado). As autarquias são entidades descentralizadas que executam atividades típicas do Estado."
        },
        {
          ...
          "answer": "Entidade pública resultante de acordo formal entre dois ou mais municípios, estados ou entre município(s), estado(s) e a União",
          "feedback": "Um consórcio público é uma entidade pública resultante de acordo formal entre dois ou mais municípios, estados ou entre município(s), estado(s) e a União. Esta forma de organização permite que diferentes entes federativos se unam para prestar serviços de forma mais eficiente, compartilhando recursos e responsabilidades."
        },
        {
          ...
          "answer": "Reúne diferentes entes federativos das três esferas administrativas do país (União e/ou Estados e/ou Municípios)",
          "feedback": "A esfera interfederativa reúne diferentes entes federativos das três esferas administrativas do país (União e/ou Estados e/ou Municípios). Esta classificação é importante para identificar quando um prestador de serviço atua em parceria com diferentes níveis de governo, permitindo uma gestão mais integrada dos serviços de drenagem."
        },
        {
          ...
          "answer": "Entidade com capital público e privado, maioria pública nas ações com direito a voto",
          "feedback": "Uma sociedade de economia mista é uma entidade com capital público e privado, onde a maioria das ações com direito a voto pertence ao poder público. Esta forma de organização permite a participação do setor privado mantendo o controle público, sendo comum em empresas que prestam serviços essenciais como drenagem e saneamento."
        },
        {
          ...
          "answer": "Pluviométrico registra chuva; fluviométrico registra nível/vazão de rios",
          "feedback": "A diferença é específica: o monitoramento pluviométrico registra a quantidade de chuva que cai em uma determinada área e tempo, enquanto o monitoramento fluviométrico registra o nível e vazão de rios e outros cursos d'água. Ambos são fundamentais para o planejamento e operação de sistemas de drenagem, pois fornecem dados complementares sobre precipitação e escoamento."
        },
        {
          ...
          "answer": "Construções, implementação e expansão de sistemas de drenagem novos ou preexistentes",
          "feedback": "A execução de obras, instalação e ampliação inclui construções, implementação e expansão de sistemas de drenagem novos ou preexistentes. Esta categoria abrange todas as atividades de construção civil relacionadas à drenagem, desde a instalação de novos dispositivos até a ampliação de sistemas existentes para atender ao crescimento urbano."
        },
        {
          ...
          "answer": "Revisão da identificação espacial das áreas suscetíveis a desastres",
          "feedback": "A atualização do mapeamento das áreas de risco é fundamental para a revisão da identificação espacial das áreas suscetíveis a desastres como inundação, alagamentos, enxurradas, deslizamentos e movimentos de massa. Este mapeamento é essencial para o planejamento urbano, alertas da Defesa Civil e tomada de decisões preventivas."
        },
        {
          "question": "O que significa \"abrangência territorial\" no contexto da PNSB?",
          "options": [
            "Apenas o tamanho físico da empresa",
            "Apenas a área urbana do município",
            "Apenas a população atendida",
            "A área de atuação, direta e indireta, do prestador de serviço"
          ],
          "answer": "A área de atuação, direta e indireta, do prestador de serviço",
          "feedback": "A abrangência territorial refere-se à área de atuação, direta e indireta, do prestador de serviço. Esta informação é crucial para entender se o prestador atua somente no município pesquisado ou se sua atuação se estende a outros municípios, permitindo mapear a cobertura real dos serviços de drenagem no território nacional."
        }
      ]
    }
  }
