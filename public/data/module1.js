...
Object.assign(window.modulos_data, {
  "1": {
    "title": "Módulo 1: Introdução à PNSB e Fundamentos da Drenagem e Manejo de Águas Pluviais (MAP)",
    "audio": "MAP/Audios/Curso MAP - Mod 1.mp3",
    "cards": [
      {"type": "default","title": "📖 Introdução ao Módulo 1","content": "Este módulo visa fornecer uma compreensão integral da Pesquisa Nacional de Saneamento Básico (PNSB) no contexto da Drenagem e Manejo de Águas Pluviais (MAP), abordando sua importância, conceitos essenciais, componentes do serviço e distinções cruciais entre os tipos de drenagem."},
      ...
      {"type": "default","title": "📖 1.1. Apresentação da Pesquisa Nacional de Saneamento Básico (PNSB)","content": "A Pesquisa Nacional de Saneamento Básico (PNSB) é um levantamento fundamental realizado pelo IBGE."},
      {"type": "default","title": "📜 O que é a PNSB? Definição Legal de Saneamento Básico","content": "De acordo com a Lei 11.445/2007, Art. 3º, o saneamento básico é definido como o conjunto de serviços, infraestruturas e instalações operacionais relacionados ao abastecimento de água, esgotamento sanitário, limpeza urbana e manejo de resíduos sólidos, além da drenagem e manejo de águas pluviais. Esses serviços são essenciais para a saúde humana e a preservação ambiental, contribuindo diretamente para o bem-estar social."},
      {"type": "default","title": "⏳ Histórico e Evolução da PNSB","content": "O IBGE realiza levantamentos nacionais sobre a oferta de saneamento básico no Brasil desde 1974, com edições em 1977, 1989, 2000 e 2008. A partir de 2015, a PNSB foi incluída no orçamento do IBGE para se tornar uma pesquisa regular, com coleta de informações estruturada por módulos. Os serviços de abastecimento de água e esgotamento sanitário foram pesquisados em 2017 (gestão) e 2018 (aspectos técnicos). A coleta para os serviços de limpeza urbana e manejo de resíduos sólidos, bem como drenagem e manejo de águas pluviais, foi iniciada em 2023 (gestão) e terá sua etapa técnica concluída em 2025."},
      {"type": "atencao","title": "🤝 A Importância da sua Participação","content": "A participação na PNSB é fundamental para suprir a demanda por informações municipais detalhadas sobre os serviços de limpeza urbana e manejo de resíduos sólidos, drenagem e manejo de águas pluviais. Esses dados são cruciais para o planejamento e aprimoramento da gestão do saneamento e para fortalecer a capacidade dos governos municipais de atender à população."},
      {"type": "default","title": "🎯 Objetivos da PNSB 2024","content": "A PNSB 2024 visa obter informações de entidades públicas e privadas que atuam na oferta de serviços de Limpeza Urbana e Manejo de Resíduos Sólidos e Drenagem e Manejo de Águas Pluviais, levantando aspectos legais, serviços prestados, educação ambiental, entre outros. Com esses resultados, o IBGE busca formular e disponibilizar indicadores que apresentem um cenário atualizado sobre esses serviços em todos os municípios brasileiros, permitindo análises das condições ambientais e suas implicações diretas na saúde e qualidade de vida da população."},
      {"type": "duvidas","title": "👤 Quem é o Prestador de Serviço de MAP?","content": "A pesquisa abrange prestadores de serviço com registro no Cadastro Nacional de Pessoas Jurídicas (CNPJ). Para o serviço de drenagem e manejo de águas pluviais, o prestador atua em áreas rurais ou urbanas, desempenhando pelo menos uma das seguintes atividades: mapeamento atualizado de áreas de risco, cadastro, planejamento, projeto, instalação, ampliação, adequação, monitoramento, manutenção e operação da infraestrutura de drenagem e manejo de águas pluviais. Essas atividades podem ocorrer em ruas pavimentadas ou não, em corpos d'água (rios, córregos, igarapés) ou em dispositivos (guias, sarjetas, bueiros, bocas de lobo, galerias, estruturas de amortecimento de águas pluviais e infraestruturas verdes)."},
      {"type": "default","title": "🗓️ Período de Referência e Abrangência","content": "O período de referência da pesquisa é 31 de dezembro de 2024, e todas as informações devem se referir ao ano de 2024, exceto aquelas com datas específicas no quesito.<br><br>A PNSB 2024 pretende obter informações sobre os serviços em todos os 5.570 municípios brasileiros existentes no território nacional em 2024, incluindo o Distrito Federal e o Distrito Estadual de Fernando de Noronha, tratados como municípios para fins metodológicos."},
      {"type": "default","title": "💻 Coleta de Informações","content": "A coleta das informações será realizada através do preenchimento de questionários em um sistema online desenvolvido pelo IBGE. Uma alternativa de questionário em PDF editável também será disponibilizada. É indispensável que uma cópia do manual seja distribuída à área e à pessoa envolvida com o fornecimento dos dados para o correto preenchimento dos blocos."},
      {"type": "atencao","title": "✍️ Orientações Gerais para o Preenchimento do Questionário","content": "<ul><li>Os quesitos são agrupados em blocos de acordo com o assunto.</li><li>Expressões e conceitos que exigem esclarecimento estão definidos no manual ou nos questionários.</li><li>Abreviações só podem ser usadas se os campos forem insuficientes para o preenchimento por extenso.</li><li>Existem comandos de sequência (setas ou instruções redigidas) que podem determinar saltos no preenchimento, deixando alguns quesitos em branco.</li><li>Caso o respondente não saiba informar dados como ano de vistoria/levantamento ou quantidade de itens, o item será considerado inexistente.</li><li>Nenhum quesito pode ser deixado em branco, exceto nos saltos previstos ou quando há orientação expressa no manual.</li><li>O campo de observações deve ser usado para complementar informações, sempre indicando o nome do bloco e o número do quesito.</li><li>O Bloco 'RESPONSÁVEL PELA INFORMAÇÃO DO PRESTADOR DE SERVIÇO' deve ser preenchido obrigatoriamente no início do questionário.</li></ul>"},
      {"type": "default","title": "💧 1.2. Conceitos Essenciais: Definição do Serviço de MAP","content": "O serviço de Drenagem e Manejo de Águas Pluviais (MAP) é o escoamento e infiltração da água em áreas urbanas e rurais, com controle dos impactos a jusante na bacia."},
      {"type": "default","title": "🎯 Conceitos Essenciais: Objetivos do Serviço de MAP","content": "Os objetivos do serviço são:<ul><li>Redução dos danos à sociedade e ao ambiente por chuvas e cheias.</li><li>Prevenção de alagamentos, inundações e enxurradas.</li><li>Prevenção de deslizamentos, corridas de massa e erosões.</li></ul><p>A Drenagem e Manejo de Águas Pluviais (MAP) tem o objetivo geral de reduzir os impactos causados por alagamentos, inundações, enxurradas, deslizamentos, corridas de massa e erosões, por ocasião das chuvas e cheias dos rios, nas áreas rurais ou urbanas do município, nas ruas com ou sem pavimentação.</p>"},
      {"type": "default","title": "🗣️ Conceitos Essenciais: Terminologia Chave","content": "<ul><li><b>Jusante:</b> Rio abaixo, montanha abaixo, encosta abaixo.</li><li><b>Montante:</b> Rio acima, montanha acima, encosta acima.</li></ul>"},
      {"type": "default","title": "🔬 1.3. Componentes: Microdrenagem","content": "O serviço de drenagem capta, conduz e retém a água das chuvas através de diversos componentes.<br><br><b>Microdrenagem</b>: é o sistema de dispositivos instalado responsável pelo disciplinamento das águas pluviais. Seus componentes incluem:<ul><li>Pavimentos das ruas, guias e sarjetas, bocas de lobo.</li><li>Bueiros.</li></ul><p>A microdrenagem visa a redução de riscos de alagamentos e enxurradas no sistema viário, proteção de taludes/encostas contra deslizamentos e erosões, e redução da poluição hídrica.</p>"},
      {"type": "default","title": "🌊 Componentes: Macrodrenagem","content": "<b>Macrodrenagem</b>: é o sistema de dispositivos responsável pelo escoamento final das águas. Seus componentes incluem:<ul><li>Canais naturais (igarapés, córregos, rios).</li><li>Canais artificiais (rios canalizados ou tamponados).</li><li>Galerias pluviais de grandes dimensões.</li><li>Estruturas de amortecimento de águas da chuva e grandes dispositivos de drenagem, como barragens de amortecimento de cheias, 'piscinões' e diques.</li></ul><p>Esses componentes possuem grandes dimensões e alto grau de intervenção na paisagem para controle de elevados volumes de água.</p>"},
      {"type": "exemplo","title": "🌿 Componentes: Infraestruturas Verdes","content": "As <b>Infraestruturas Verdes</b>, também conhecidas como Soluções Baseadas na Natureza (SBN) ou Drenagem Sustentável, são estruturas construídas que utilizam as funções da natureza para o manejo das águas de chuva, criando áreas naturais e espaços abertos em diferentes escalas, integradas à infraestrutura cinza (engenharia convencional).<br><br><b>Exemplos:</b> jardins de chuva, telhados verdes, parques urbanos e alagados construídos."},
      {"type": "atencao","title": "🚨 1.4. A Importância Crítica do Manejo de Águas Pluviais","content": "O manejo adequado das águas pluviais é de importância crítica para diversos aspectos:<ul><li><b>Prevenção de Enchentes e Alagamentos:</b> Evita o acúmulo de água e os consequentes prejuízos.</li><li><b>Conservação do Solo e Prevenção da Erosão:</b> Ajuda a controlar a velocidade da água em áreas rurais ou com pouca vegetação, minimizando a erosão.</li><li><b>Proteção da Infraestrutura Urbana:</b> Contribui para o aumento da durabilidade de calçadas, ruas, pontes e edifícios.</li><li><b>Recarga dos Lençóis Freáticos:</b> Técnicas de infiltração, como jardins de chuva e bacias de retenção, alimentam os aquíferos subterrâneos.</li><li><b>Redução da Poluição Hídrica:</b> Um manejo correto, que inclui o uso de filtros e bacias de contenção, diminui a contaminação de rios e lagos por resíduos e produtos químicos carregados pela água da chuva.</li></ul>"},
      {"type": "default","title": "🏙️ vs. 🌳 1.5. Distinção entre Drenagem Urbana e Rural","content": "É crucial diferenciar os sistemas de drenagem de acordo com o ambiente em que estão inseridos:<ul><li><b>Drenagem Urbana:</b> Refere-se ao sistema implementado nas vias urbanas. Seu principal objetivo é o aumento da velocidade de escoamento da água da chuva, visando a menor ocorrência de inundações e alagamentos em áreas edificadas.</li><li><b>Drenagem Rural:</b> Diz respeito ao sistema aplicado nas vias rurais. Diferentemente da urbana, seu propósito é a diminuição da velocidade da água, o aumento da infiltração no solo e, consequentemente, a menor erosão do terreno.</li></ul>"},
      {"type": "atencao","title": "⚠️ Áreas de Expansão Urbana e Novos Loteamentos","content": "Essas áreas são grandes indutores de problemas como erosão, perda de solo e assoreamento se não contarem com um sistema de drenagem adequado desde o planejamento e execução."}
    ],
    "quiz": {
      ...
      "questions": [
        {
          ...
          "answer": "Planejar e aprimorar a gestão dos serviços de saneamento no Brasil",
          "feedback": "A PNSB é um levantamento fundamental realizado pelo IBGE desde 1974, com o objetivo principal de planejar e aprimorar a gestão municipal dos serviços de saneamento. A pesquisa coleta informações de prestadores em todos os 5.570 municípios brasileiros, fornecendo um cenário atualizado para análises das condições ambientais e suas implicações na saúde e qualidade de vida da população."
        },
        {
        ...
        },
        {
          ...
          "feedback": "A coleta das informações da PNSB é realizada através do preenchimento de questionários em um sistema online desenvolvido pelo IBGE. Uma alternativa de questionário em PDF editável também será disponibilizada. É indispensável que uma cópia do manual seja distribuída à área e à pessoa envolvida com o fornecimento dos dados para o correto preenchimento dos blocos."
        },
        {
